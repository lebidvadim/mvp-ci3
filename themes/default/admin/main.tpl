...
<head>
	...
	<!-- dialog CSS
		============================================ -->
	{$theme->css('assets/css/dialog/sweetalert2.min.css')}
	{$theme->css('assets/css/dialog/dialog.css')}
	<!-- Bootstrap CSS
		============================================ -->
	...
	{$theme->css('assets/css/wave/button.css')}
	<!-- main CSS
		============================================ -->
	{$theme->css('assets/css/main.css')}
	<!-- style CSS
		============================================ -->
	{$theme->css('assets/css/style.css?v=1224')}
	<!-- responsive CSS
		============================================ -->
	...
	<body>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="logo-area">
								<a href="{site_url('admin')}"><img src="{theme_url()}assets/img/logo/logo.png" alt="" /><sup>{$user->group->name}</sup></a>
							</div>
						</div>
									...
									<li>
										<div class="dropdown-trig-sgn">
											...
											<ul class="dropdown-menu triger-bounceIn-dp">
												<li><a href="{site_url('admin/profile/edit-profile')}">{__('Ред. профиль')}</a></li>
												<li class="divider"></li>
			...
			<div class="wrap{if !empty($menu_act['submenu']) or $active == 'home'} submenu{/if}">
			{if $breadcrumb}
		...
		<!--  Chat JS
		============================================ -->
		{$theme->js('assets/js/dialog/sweetalert2.min.js')}
		{$theme->js('assets/js/dialog/dialog-active.js')}
		<!-- wow JS
			============================================ -->
