 ...
 */
$config['site_title']                 = "mvp.lebid.pro";       // Site Title, example.com
$config['admin_email']                = "midav1991@gmail.com"; // Admin Email, admin@example.com
...
$config['user_expire']                = 86500*365;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'site/auth/email/';
